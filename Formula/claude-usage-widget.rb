class ClaudeUsageWidget < Formula
  ...
  url "https://files.pythonhosted.org/packages/10/58/a0cc762f49e7d3ff55e9fd6e1f763f4436f0d1da08401a19cf42e991efac/claude_usage_widget-0.8.0.tar.gz"
  sha256 "68c4895a67b77eb799f15888a8e10962fab6b69e5d3d23489e64af0ee92f7760"
  license "MIT"
  ...
  test do
    assert_match "0.8.0", shell_output("#{bin}/claude-usage --version")
  end
end
